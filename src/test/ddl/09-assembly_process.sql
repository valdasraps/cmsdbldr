...
values (1,7,&l_prep_attr_id,'F','COMPLETED');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (2,10,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE,AAD_STEP_STATUS)
values (3,10,&l_top_attr_id,'F','COMPLETED');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (4,11,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (5,11,&l_bottom_attr_id,'F');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (6,14,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (7,14,&l_top_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (8,15,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (9,15,&l_bottom_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (10,19,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (11,19,&l_top_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (12,20,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (13,20,&l_bottom_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (14,23,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (15,23,&l_top_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (16,26,&l_prep_attr_id,'T');

insert into ASSEMBLY_ATTRIBUTE_DEFINITIONS (AAD_ID,AAD_APD_ID,AAD_ATTRIBUTE_ID,AAD_IS_SELECTABLE)
values (17,26,&l_bottom_attr_id,'T');