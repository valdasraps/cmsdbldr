...
--------------------------------------------------------
  ...
  ALTER TABLE "ASSEMBLY_DATA" ADD CONSTRAINT "AED_UK" UNIQUE ("AED_ADD_ID", "AED_ASS_ID", "AED_DATA_SET_ID");
  ALTER TABLE "ASSEMBLY_DATA" MODIFY ("AED_ID" NOT NULL ENABLE);
  ALTER TABLE "ASSEMBLY_DATA" MODIFY ("AED_ADD_ID" NOT NULL ENABLE);
  ALTER TABLE "ASSEMBLY_DATA" MODIFY ("AED_ASS_ID" NOT NULL ENABLE);
  ...
  ALTER TABLE "ASSEMBLY_DATA" ADD CONSTRAINT "AED_ASS_FK" FOREIGN KEY ("AED_ASS_ID")
