...
CREATE SEQUENCE  "ANY_REQUESTS_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 2 NOORDER  NOCYCLE ;
...
CREATE SEQUENCE  "ANY_REQUESTS_HISTORY_ID_SEQ"  MINVALUE 1 MAXVALUE 99999999999999999999 INCREMENT BY 1 START WITH 7 CACHE 2 NOORDER  NOCYCLE ;
...
GRANT INSERT, UPDATE ON REQUESTS TO CMS_TRK_TRKER_CONSTRUCT_WRITER;
GRANT SELECT, REFERENCES ON REQUESTS TO CMS_TRK_TRKER_CONSTRUCT;
...
CREATE TABLE "REQUEST_ITEMS_HST" (
    ...
    "RQI_QUANTITY" NUMBER NOT NULL ENABLE,
    "RQI_COMMENT" VARCHAR2(1024 BYTE), 
    "HISTORY_INSERTION_TIME" TIMESTAMP (6) NOT NULL ENABLE, 
    "HISTORY_INSERTION_USER" VARCHAR2(50 BYTE) NOT NULL ENABLE, 
    "RECORD_LASTUPDATE_TIME" TIMESTAMP (6), 
    "RECORD_LASTUPDATE_USER" VARCHAR2(50 BYTE),

    CONSTRAINT "REQUEST_ITEMS_HST_PK" PRIMARY KEY ("HISTORY_RECORD_ID"), 
    CONSTRAINT "REQUEST_ITEMS_HST_CHK1" CHECK (RQI_QUANTITY > 0) ENABLE,
    CONSTRAINT "REQUEST_ITEMS_HST_FK1" FOREIGN KEY ("RQI_REQ_ID") REFERENCES "REQUESTS" ("REQ_ID") ENABLE, 
    CONSTRAINT "REQUEST_ITEMS_HST_FK2" FOREIGN KEY ("RQI_KIND_OF_PART_ID") REFERENCES "KINDS_OF_PARTS" ("KIND_OF_PART_ID") ENABLE

 );

CREATE SEQUENCE  "CMS_TST_CORE_CONSTRUCT"."ANY_REQUEST_ITM_HISTORY_ID_SEQ"  MINVALUE 1 MAXVALUE 99999999999999999999 INCREMENT BY 1 START WITH 7 CACHE 2 NOORDER  NOCYCLE ;
...
CREATE SEQUENCE  "ANY_SHIPMENTS_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 7 CACHE 2 NOORDER  NOCYCLE ;

GRANT SELECT ON SHIPMENTS TO PUBLIC;
GRANT INSERT, UPDATE ON SHIPMENTS TO CMS_TRK_TRKER_CONSTRUCT_WRITER;
GRANT SELECT, REFERENCES ON SHIPMENTS TO CMS_TRK_TRKER_CONSTRUCT;
/*
SHIPMENTS HISTORY
*/
CREATE TABLE "SHIPMENTS_HST" (
    ...
    CONSTRAINT "SHIPMENTS_HST_CHK1" CHECK (SHP_STATUS in ('PACKAGING', 'SHIPPED','RECEIVED','CANCELED')) ENABLE, 
    CONSTRAINT "SHIPMENTS_HST_FK1" FOREIGN KEY ("SHP_FROM_LOCATION_ID") REFERENCES "CMS_&det._CORE_MANAGEMNT"."LOCATIONS" ("LOCATION_ID") ENABLE, 
    CONSTRAINT "SHIPMENTS_HST_FK2" FOREIGN KEY ("SHP_TO_LOCATION_ID") REFERENCES "CMS_&det._CORE_MANAGEMNT"."LOCATIONS" ("LOCATION_ID") ENABLE

);

CREATE SEQUENCE  "ANY_SHIPMENTS_HISTOANY_SHP_ITM_ID_SEQRY_ID_SEQ"  MINVALUE 1 MAXVALUE 99999999999999999999 INCREMENT BY 1 START WITH 9 CACHE 2 NOORDER  NOCYCLE ;
...
CREATE TABLE "SHIPMENT_ITEMS_HST" (
    ...
    CONSTRAINT "SHIPMENT_ITEMS_HST_FK1" FOREIGN KEY ("SHI_PART_ID") REFERENCES "PARTS" ("PART_ID") ENABLE, 
    CONSTRAINT "SHIPMENT_ITEMS_HST_FK2" FOREIGN KEY ("SHI_SHP_ID")  REFERENCES "SHIPMENTS" ("SHP_ID") ENABLE, 
    CONSTRAINT "SHIPMENT_ITEMS_HST_FK3" FOREIGN KEY ("SHI_RQI_ID")  REFERENCES "REQUEST_ITEMS" ("RQI_ID") ENABLE

);

   CREATE SEQUENCE  "ANY_SHIPMENT_ITM_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 2 NOORDER  NOCYCLE ;
   CREATE SEQUENCE  "ANY_SHIPMENT_ITM_HST_ID_SEQ"  MINVALUE 1 MAXVALUE 99999999999999999999 INCREMENT BY 1 START WITH 7 CACHE 2 NOORDER  NOCYCLE ;
